...
/** HTTP session state for vault PIN unlock (separate from application login). */
public final class VaultSession {

    public static final String UNLOCKED_BUILDER_ID = "floor21.vault.unlockedBuilderId";
    public static final String UNLOCKED_AT = "floor21.vault.unlockedAt";
